...
<head>
    ...
    <style>
        ...
        /* Old typing indicator styles moved to proper section with !important */
        ...
        /* Individual Typing Dots - Perfect Size & Animation with High Specificity */
        ...
        div.typing-dot {
            ...
            border-radius: 50% !important;
            animation: liveTypingAnimation 1.4s infinite ease-in-out !important;
        ...
        /* Sequential Animation Delays for Realistic Effect - High Specificity */
        .typing-indicator .typing-dot:nth-child(1),
        .chat-bubble .typing-dot:nth-child(1),
        div.typing-dot:nth-child(1) {
        ...
        /* Live Typing Animation - Smooth Bounce with Vertical Movement */
        @keyframes liveTypingAnimation {
            0%, 80%, 100% {
                transform: scale(0.6) translateY(0px) !important;
        ...
        /* Fallback Simple Animation - In case complex animation fails */
        @keyframes simpleTypingDots {
            0%, 60%, 100% {
        ...
        /* Chat Attachment Icon - Alternative Selector */
        ...
        /* Chat Attachment Icon - Highest Specificity */
        div.chat-input-container button.chat-attach-btn span.chat-attach-icon {
            font-size: 20px !important;
            width: 20px !important;
            height: 20px !important;
        }
        ...
        /* Emoji Mart Category Buttons */
        .emoji-picker-container em-emoji-picker .category button {
            border-radius: 8px !important;
            transition: all 0.2s ease !important;
        }

        /* Emoji Mart Search Input */
        .emoji-picker-container em-emoji-picker input {
            border-radius: 8px !important;
            border: 1px solid #e5e7eb !important;
            padding: 8px 12px !important;
            font-family: 'Poppins', sans-serif !important;
        ...
        /* Emoji Mart Individual Emojis */
        .emoji-picker-container em-emoji-picker button[data-emoji] {
            border-radius: 6px !important;
            transition: all 0.2s ease !important;
        }

        .emoji-picker-container em-emoji-picker button[data-emoji]:hover {
            background: #f3f4f6 !important;
            transform: scale(1.1) !important;
        }

        /* Hide emoji when input has content */
        .chat-input-container .chat-textarea-input:not(:placeholder-shown) + * .chat-input-container .flex-1::after,
        .chat-input-container .chat-textarea-input:focus + * .chat-input-container .flex-1::after {
            display: none !important;
        }
        ...
        /* Additional Send Button Center Fix */
        .chat-input-container .chat-send-btn {
            display: flex !important;
            align-items: center !important;
            justify-content: center !important;
        ...
        /* Material Icons Font Fix for Perfect Centering */
        ...
        /* Show State Override for Typing Indicator */
        #typingIndicator:not(.hidden) {
            display: flex !important;
        }
...
<body class="bg-gray-50 font-sans min-h-screen flex flex-col" data-theme="corporate">
            ...
            <div class="bg-white shadow-lg border-x border-gray-200">
                ...
                <div class="flex">
                    ...
                    <div class="w-56 bg-white border-r border-gray-200 flex flex-col nav-sidebar" style="height: calc(100vh - 180px) !important;">
                        <!-- Navigation Header -->
                        <div class="p-6 flex-shrink-0 !important">
                    ...
                    <div class="flex-1 bg-white flex flex-col" style="height: calc(100vh - 180px) !important;">
                        ...
                        <div class="main-content-container" id="mainContentArea">
                            ...
                            <div id="chatInterface" class="space-y-0">
                                <!-- User Item 1 -->
                                <div class="flex items-center cursor-pointer content-item" onclick="openChat('Ahmad Razak', 'Kecemasan', 'Menunggu sokongan untuk masalah upload dokumen...')">
                                        ...
                                        <div class="chat-user-info-section">
                                            ...
                                            <div class="chat-user-details-section">
                                                ...
                                                <div class="chat-user-status-section">
                                                    ...
                                                    <span class="chat-status-text">Dalam Talian</span>
    ...
    <!-- Updated JavaScript for Documents-Style Layout -->
        ...
        // Chat functions
        function openChat(userName, priority, description) {
            const chatInterface = document.getElementById('chatInterface');
            const ticketInterface = document.getElementById('ticketInterface');
        ...
        function sendMessage() {
            ...
            setTimeout(() => {
                ...
                showTypingIndicator();
                // Fixed typing duration for better UX (2-4 seconds)
                const typingDuration = 2000 + Math.random() * 2000;
                console.log('Typing duration:', typingDuration + 'ms');
                setTimeout(() => {
                    console.log('Hiding typing indicator and showing bot response...');
                    hideTypingIndicator();
                    addBotResponse();
                }, typingDuration);
            }, 500); // Reduced delay before showing typing
        }
        ...
        function showTypingIndicator() {
            ...
            console.log('typingIndicator element:', typingIndicator);
            ...
            console.log('Display style:', typingIndicator.style.display);
            console.log('Visibility:', typingIndicator.style.visibility);
            
            // Force animation restart on typing dots with fallback
            const typingDots = typingIndicator.querySelectorAll('.typing-dot');
            console.log('Found typing dots:', typingDots.length);
            ...
            typingDots.forEach((dot, index) => {
                ...
                // Try complex animation first
                dot.style.animation = `liveTypingAnimation 1.4s infinite ease-in-out`;
                dot.style.animationDelay = index === 0 ? '-0.32s' : index === 1 ? '-0.16s' : '0s';
                dot.style.animationFillMode = 'both';
                dot.style.willChange = 'transform, opacity';
                dot.style.visibility = 'visible';
                dot.style.opacity = '1';
                
                console.log(`Dot ${index + 1} animation set:`, dot.style.animation);
                
                // Fallback: If animation doesn't start, use simple animation
                setTimeout(() => {
                    const computedStyle = window.getComputedStyle(dot);
                    if (computedStyle.animationName === 'none') {
                        console.log('Using fallback animation for typing dot', index + 1);
                        dot.style.animation = `simpleTypingDots 1.2s infinite ease-in-out`;
                        dot.style.animationDelay = index === 0 ? '-0.4s' : index === 1 ? '-0.2s' : '0s';
                    }
                }, 100);
            });
            ...
            setTimeout(() => {
                chatMessages.scrollTop = chatMessages.scrollHeight;
                console.log('Scrolled to show typing indicator');
            }, 50);
        }
        ...
        function hideTypingIndicator() {
            ...
            if (typingIndicator) {
                ...
                console.error('Typing indicator element not found in hideTypingIndicator!');
            }
        }

        function addBotResponse() {
            console.log('addBotResponse called - adding bot message');
            const chatMessages = document.getElementById('chatMessages');
            ...
            const messageDiv = document.createElement('div');
            messageDiv.className = 'message-bubble message-received';
        ...
        // Using emoji-mart package for professional emoji picker
        // Package installed: npm install emoji-mart
        // CDN: https://cdn.jsdelivr.net/npm/emoji-mart@latest/dist/browser.js
        ...
        function initializeEmojiPicker() {
            if (!emojiPickerInstance && window.EmojiMart) {
                ...
                emojiPickerInstance = new window.EmojiMart.Picker({
                    ...
                    theme: 'light',
                    locale: 'en', // Use English for now (Bahasa Malaysia not available)
