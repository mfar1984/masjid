...
<head>
    ...
    <title>Kemaskini Asnaf - E-Masjid</title>
    <x-favicon />
    ...
    <main class="flex-1">
        <div class="container mx-auto px-0 py-0">
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                <div class="mb-6">
                    <h1 class="text-xl font-bold text-gray-900 mb-1">Kemaskini Maklumat Asnaf</h1>
                    <p class="text-xs text-gray-600">Kemaskini maklumat permohonan bantuan zakat</p>
                </div>
                <form method="POST" action="{{ route('asnaf.update', $asnaf) }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama" value="{{ old('nama', $asnaf->nama) }}" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('nama') border-red-500 @enderror">
                                @error('nama')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <div>
                                <label class="form-label text-gray-700 mb-1">No. IC *</label>
                                <input type="text" name="no_ic" value="{{ old('no_ic', $asnaf->no_ic) }}" required maxlength="14" oninput="formatIC(this)" class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('no_ic') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <select name="jantina" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('jantina') border-red-500 @enderror">
                                    ...
                                    <option value="Lelaki" {{ old('jantina', $asnaf->jantina) == 'Lelaki' ? 'selected' : '' }}>Lelaki</option>
                                    <option value="Perempuan" {{ old('jantina', $asnaf->jantina) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select name="bangsa" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('bangsa') border-red-500 @enderror">
                                    ...
                                    @foreach($bangsa as $item)
                                        <option value="{{ $item->nama_kategori }}" {{ old('bangsa', $asnaf->bangsa) == $item->nama_kategori ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="agama" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('agama') border-red-500 @enderror">
                                    ...
                                    @foreach($agama as $item)
                                        <option value="{{ $item->nama_kategori }}" {{ old('agama', $asnaf->agama) == $item->nama_kategori ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="status_perkahwinan" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('status_perkahwinan') border-red-500 @enderror">
                                    ...
                                    @foreach($statusPerkahwinan as $item)
                                        <option value="{{ $item->nama_kategori }}" {{ old('status_perkahwinan', $asnaf->status_perkahwinan) == $item->nama_kategori ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="telefon" value="{{ old('telefon', $asnaf->telefon) }}" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('telefon') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="text" name="telefon_alternatif" value="{{ old('telefon_alternatif', $asnaf->telefon_alternatif) }}" class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div class="md:col-span-2">
                                <label class="form-label text-gray-700 mb-1">Email</label>
                                <input type="email" name="email" value="{{ old('email', $asnaf->email) }}" class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                ...
                                <textarea name="alamat_ic" rows="2" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('alamat_ic') border-red-500 @enderror">{{ old('alamat_ic', $asnaf->alamat_ic) }}</textarea>
                            ...
                            <div>
                                ...
                                <input type="text" name="poskod_ic" value="{{ old('poskod_ic', $asnaf->poskod_ic) }}" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
                                <label class="form-label text-gray-700 mb-1">Bandar *</label>
                                <input type="text" name="bandar_ic" value="{{ old('bandar_ic', $asnaf->bandar_ic) }}" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div class="md:col-span-2">
                                ...
                                <select name="negeri_ic" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    @foreach($negeri as $item)
                                        <option value="{{ $item->nama_kategori }}" {{ old('negeri_ic', $asnaf->negeri_ic) == $item->nama_kategori ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                <label class="form-label text-gray-700 mb-1">Alamat *</label>
                                <textarea name="alamat_surat" rows="2" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('alamat_surat', $asnaf->alamat_surat) }}</textarea>
                            </div>
                            <div>
                                <label class="form-label text-gray-700 mb-1">Poskod *</label>
                                <input type="text" name="poskod_surat" value="{{ old('poskod_surat', $asnaf->poskod_surat) }}" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
                                <label class="form-label text-gray-700 mb-1">Bandar *</label>
                                <input type="text" name="bandar_surat" value="{{ old('bandar_surat', $asnaf->bandar_surat) }}" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div class="md:col-span-2">
                                <label class="form-label text-gray-700 mb-1">Negeri *</label>
                                <select name="negeri_surat" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="">-- Pilih Negeri --</option>
                                    @foreach($negeri as $item)
                                        <option value="{{ $item->nama_kategori }}" {{ old('negeri_surat', $asnaf->negeri_surat) == $item->nama_kategori ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                <label class="form-label text-gray-700 mb-1">Alamat *</label>
                                <textarea name="alamat_kediaman" rows="2" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('alamat_kediaman', $asnaf->alamat_kediaman) }}</textarea>
                            </div>
                            <div>
                                <label class="form-label text-gray-700 mb-1">Poskod *</label>
                                <input type="text" name="poskod_kediaman" value="{{ old('poskod_kediaman', $asnaf->poskod_kediaman) }}" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
                                <label class="form-label text-gray-700 mb-1">Bandar *</label>
                                <input type="text" name="bandar_kediaman" value="{{ old('bandar_kediaman', $asnaf->bandar_kediaman) }}" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
                                <label class="form-label text-gray-700 mb-1">Negeri *</label>
                                <select name="negeri_kediaman" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="">-- Pilih Negeri --</option>
                                    @foreach($negeri as $item)
                                        <option value="{{ $item->nama_kategori }}" {{ old('negeri_kediaman', $asnaf->negeri_kediaman) == $item->nama_kategori ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama_waris" value="{{ old('nama_waris', $asnaf->nama_waris) }}" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
                                <label class="form-label text-gray-700 mb-1">Hubungan *</label>
                                <input type="text" name="hubungan_waris" value="{{ old('hubungan_waris', $asnaf->hubungan_waris) }}" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: Anak, Suami, Isteri">
                            </div>
                            <div>
                                <label class="form-label text-gray-700 mb-1">No. IC Waris *</label>
                                <input type="text" name="no_ic_waris" value="{{ old('no_ic_waris', $asnaf->no_ic_waris) }}" required maxlength="14" oninput="formatIC(this)" class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
                                <label class="form-label text-gray-700 mb-1">Telefon Waris *</label>
                                <input type="text" name="telefon_waris" value="{{ old('telefon_waris', $asnaf->telefon_waris) }}" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div class="md:col-span-2">
                                <label class="form-label text-gray-700 mb-1">Alamat Waris</label>
                                <textarea name="alamat_waris" rows="2" class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('alamat_waris', $asnaf->alamat_waris) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded p-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <select name="kategori_asnaf" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    @foreach($kategoriAsnafList as $item)
                                        <option value="{{ $item->nama_kategori }}" {{ old('kategori_asnaf', $asnaf->kategori_asnaf) == $item->nama_kategori ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <textarea name="sebab_permohonan" rows="4" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Nyatakan sebab permohonan dengan terperinci">{{ old('sebab_permohonan', $asnaf->sebab_permohonan) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="status_pekerjaan" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    @foreach($statusPekerjaan as $item)
                                        <option value="{{ $item->nama_kategori }}" {{ old('status_pekerjaan', $asnaf->status_pekerjaan) == $item->nama_kategori ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_majikan" value="{{ old('nama_majikan', $asnaf->nama_majikan) }}" class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
                                <label class="form-label text-gray-700 mb-1">Jawatan</label>
                                <input type="text" name="jawatan" value="{{ old('jawatan', $asnaf->jawatan) }}" class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="sumber_pendapatan_lain" value="{{ old('sumber_pendapatan_lain', $asnaf->sumber_pendapatan_lain) }}" class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: Sewa rumah, dividen">
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="hutangFields" style="display: {{ old('ada_hutang') == '1' ? 'block' : 'none' }};">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="sebab_berhutang" rows="2" class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('sebab_berhutang', $asnaf->sebab_berhutang) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="status_kesihatan" required class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    @foreach($statusKesihatan as $item)
                                        <option value="{{ $item->nama_kategori }}" {{ old('status_kesihatan', $asnaf->status_kesihatan) == $item->nama_kategori ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="jenis_penyakit" value="{{ old('jenis_penyakit', $asnaf->jenis_penyakit) }}" class="w-full px-3 py-2 border border-gray-200 rounded text-xs focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            <div class="md:col-span-2">
