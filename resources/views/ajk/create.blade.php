...
<head>
    ...
    <title>Tambah Ahli Jawatankuasa - E-Masjid</title>
    <x-favicon />
            ...
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                ...
                <div class="mb-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-xl font-bold text-gray-900 mb-1">Tambah Ahli Jawatankuasa</h1>
                            <p class="text-xs text-gray-600">Tambah ahli jawatankuasa baru ke dalam sistem</p>
                        </div>
                    </div>
                </div>

                <!-- Form -->
                <form method="POST" action="{{ route('ajk.store') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div class="bg-gray-50 rounded p-4 border border-gray-200">
                        ...
                        <div class="flex items-center gap-6">
                            <div id="gambar-preview" class="w-24 h-24 border-2 border-dashed border-gray-300 rounded-full flex items-center justify-center bg-white flex-shrink-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama" value="{{ old('nama', $copyFrom->nama ?? '') }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="no_ic" value="{{ old('no_ic', $copyFrom->no_ic ?? '') }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="telefon" value="{{ old('telefon', $copyFrom->telefon ?? '') }}" required
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email', $copyFrom->email ?? '') }}"
                        ...
                        >
                            ...
                            <option value="Lelaki" {{ old('jantina', $copyFrom->jantina ?? '') == 'Lelaki' ? 'selected' : '' }}>Lelaki</option>
                            <option value="Perempuan" {{ old('jantina', $copyFrom->jantina ?? '') == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                            <option value="Tidak Dinyatakan" {{ old('jantina', $copyFrom->jantina ?? '') == 'Tidak Dinyatakan' ? 'selected' : '' }}>Tidak Dinyatakan</option>
                        </x-forms.input-field>

                        <!-- Jawatan (Manual Input) -->
                        <div>
                            <label class="form-label text-gray-700 mb-1">Jawatan *</label>
                            <input type="text" name="jawatan" value="{{ old('jawatan', $copyFrom->jawatan ?? '') }}" required
                        ...
                        <div>
                            ...
                            <input type="number" name="urutan" value="{{ old('urutan', $copyFrom->urutan ?? '') }}" min="1" max="9"
                        ...
                        <div>
                            ...
                            <input type="date" name="tarikh_lantikan" value="{{ old('tarikh_lantikan', $copyFrom?->tarikh_lantikan?->format('Y-m-d') ?? '') }}" required
                        ...
                        <div>
                            ...
                            <input type="date" name="tarikh_tamat" value="{{ old('tarikh_tamat', $copyFrom?->tarikh_tamat?->format('Y-m-d') ?? '') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="tempoh_jawatan" value="{{ old('tempoh_jawatan', $copyFrom->tempoh_jawatan ?? '') }}"
                    ...
                    <div>
                        ...
                        <textarea name="alamat" rows="3"
                            ...
                            placeholder="Masukkan alamat penuh">{{ old('alamat', $copyFrom->alamat ?? '') }}</textarea>
                        @error('alamat')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
    ...
    <script>
        ...
        document.getElementById('gambar-input').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                preview.innerHTML = '<span class="material-icons text-gray-400" style="font-size: 32px;">person</span>';
            }
        });
    </script>
</body>
