    ...
    <main class="flex-1">
        <div class="container mx-auto px-0 py-0">
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                ...
                <!-- Form -->
                <form method="POST" action="{{ route('kariah.update', $kariah) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="nama" name="nama" value="{{ old('nama', $kariah->nama) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" id="no_ic" name="no_ic" value="{{ old('no_ic', $kariah->no_ic) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" id="telefon" name="telefon" value="{{ old('telefon', $kariah->telefon) }}" required
                        ...
                        <div>
                            ...
                            <input type="date" id="tarikh_keahlian" name="tarikh_keahlian" value="{{ old('tarikh_keahlian', $kariah->tarikh_keahlian->format('Y-m-d')) }}" required
                        ...
                        <div>
                            ...
                            <select id="zon" name="zon"
                                ...
                                @foreach($zones as $zone)
                                    <option value="{{ $zone }}" {{ old('zon', $kariah->zon) == $zone ? 'selected' : '' }}>{{ $zone }}</option>
                                @endforeach
                                <option value="Zon Baru" {{ old('zon', $kariah->zon) == 'Zon Baru' ? 'selected' : '' }}>Zon Baru</option>
                            </select>
                            @error('zon')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email', $kariah->email) }}"
                    ...
                    <div class="flex justify-end space-x-3 pt-6">
                        <a href="{{ route('kariah.show', $kariah) }}" class="px-4 py-2 text-xs text-gray-700 bg-gray-100 rounded-xs hover:bg-gray-200">
                            Batal
                        </a>
