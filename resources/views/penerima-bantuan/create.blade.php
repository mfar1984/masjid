...
<head>
    ...
    <title>Tambah Penerima Bantuan - E-Masjid</title>
    <x-favicon />
        ...
        <div class="container mx-auto px-0 py-0">
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 mb-1">Tambah Penerima Bantuan</h1>
                        <p class="text-xs text-gray-600">Daftar penerima bantuan kebajikan baharu</p>
                    </div>
                ...
                <form method="POST" action="{{ route('penerima-bantuan.store') }}">
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="nama_penuh" name="nama_penuh" value="{{ old('nama_penuh') }}" required maxlength="255" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            ...
                            <div>
                                ...
                                <input type="text" id="no_kp" name="no_kp" value="{{ old('no_kp') }}" required maxlength="12" pattern="[0-9]{12}" placeholder="000000000000" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            ...
                            <div>
                                ...
                                <div class="flex gap-4">
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="jantina" value="Lelaki" {{ old('jantina') == 'Lelaki' ? 'checked' : '' }} required class="mr-2">
                                        <span class="text-xs">Lelaki</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="jantina" value="Perempuan" {{ old('jantina') == 'Perempuan' ? 'checked' : '' }} required class="mr-2">
                            ...
                            <div>
                                ...
                                <input type="date" id="tarikh_lahir" name="tarikh_lahir" value="{{ old('tarikh_lahir') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            ...
                            <div>
                                ...
                                <select id="agama" name="agama" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    ...
                                    @foreach($agama as $item)
                                        <option value="{{ $item->nama_kategori }}" {{ old('agama') == $item->nama_kategori ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select id="status_perkahwinan" name="status_perkahwinan" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    ...
                                    <option value="Bercerai" {{ old('status_perkahwinan') == 'Bercerai' ? 'selected' : '' }}>Bercerai</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" id="kewarganegaraan" name="kewarganegaraan" value="{{ old('kewarganegaraan', 'Malaysia') }}" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="no_telefon" name="no_telefon" value="{{ old('no_telefon') }}" required placeholder="01X-XXXXXXX" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            ...
                            <div>
                                ...
                                <input type="text" id="no_telefon_kecemasan" name="no_telefon_kecemasan" value="{{ old('no_telefon_kecemasan') }}" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>

                            <div class="md:col-span-2">
                                <label for="emel" class="block text-xs font-medium text-gray-700 mb-2">Emel</label>
                                <input type="email" id="emel" name="emel" value="{{ old('emel') }}" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="text" id="alamat_1" name="alamat_1" value="{{ old('alamat_1') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            ...
                            <div>
                                ...
                                <input type="text" id="alamat_2" name="alamat_2" value="{{ old('alamat_2') }}" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>

                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <label for="poskod" class="block text-xs font-medium text-gray-700 mb-2">Poskod *</label>
                                    <input type="text" id="poskod" name="poskod" value="{{ old('poskod') }}" required maxlength="5" pattern="[0-9]{5}" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="bandar" name="bandar" value="{{ old('bandar') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                ...
                                <div>
                                    ...
                                    <select id="negeri" name="negeri" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                        ...
                                        <option value="Penang" {{ old('negeri') == 'Penang' ? 'selected' : '' }}>Penang</option>
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" id="bilangan_tanggungan" name="bilangan_tanggungan" value="{{ old('bilangan_tanggungan', 0) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>

                            <div>
                                <label for="bilangan_anak" class="block text-xs font-medium text-gray-700 mb-2">Bilangan Anak</label>
                                <input type="number" id="bilangan_anak" name="bilangan_anak" value="{{ old('bilangan_anak', 0) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>

                            <div>
                                <label for="bilangan_anak_sekolah" class="block text-xs font-medium text-gray-700 mb-2">Bilangan Anak Sekolah</label>
                                <input type="number" id="bilangan_anak_sekolah" name="bilangan_anak_sekolah" value="{{ old('bilangan_anak_sekolah', 0) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div>
                                <label for="nama_pasangan" class="block text-xs font-medium text-gray-700 mb-2">Nama Pasangan</label>
                                <input type="text" id="nama_pasangan" name="nama_pasangan" value="{{ old('nama_pasangan') }}" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>

                            <div>
                                <label for="no_kp_pasangan" class="block text-xs font-medium text-gray-700 mb-2">No. KP Pasangan</label>
                                <input type="text" id="no_kp_pasangan" name="no_kp_pasangan" value="{{ old('no_kp_pasangan') }}" maxlength="12" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>

                            <div>
                                <label for="pekerjaan_pasangan" class="block text-xs font-medium text-gray-700 mb-2">Pekerjaan Pasangan</label>
                                <input type="text" id="pekerjaan_pasangan" name="pekerjaan_pasangan" value="{{ old('pekerjaan_pasangan') }}" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>

                            <div>
                                <label for="pendapatan_pasangan" class="block text-xs font-medium text-gray-700 mb-2">Pendapatan Pasangan (RM)</label>
                                <input type="number" id="pendapatan_pasangan" name="pendapatan_pasangan" value="{{ old('pendapatan_pasangan') }}" step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select id="status_pekerjaan" name="status_pekerjaan" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    ...
                                    <option value="Pesara" {{ old('status_pekerjaan') == 'Pesara' ? 'selected' : '' }}>Pesara</option>
                                    <option value="OKU" {{ old('status_pekerjaan') == 'OKU' ? 'selected' : '' }}>OKU</option>
                                    <option value="Pelajar" {{ old('status_pekerjaan') == 'Pelajar' ? 'selected' : '' }}>Pelajar</option>
                                    <option value="Suri Rumah" {{ old('status_pekerjaan') == 'Suri Rumah' ? 'selected' : '' }}>Suri Rumah</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" id="pekerjaan" name="pekerjaan" value="{{ old('pekerjaan') }}" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>

                            <div>
                                <label for="majikan" class="block text-xs font-medium text-gray-700 mb-2">Majikan</label>
                                <input type="text" id="majikan" name="majikan" value="{{ old('majikan') }}" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>

                            <div>
                                <label for="pendapatan_bulanan" class="block text-xs font-medium text-gray-700 mb-2">Pendapatan Bulanan (RM)</label>
                                <input type="number" id="pendapatan_bulanan" name="pendapatan_bulanan" value="{{ old('pendapatan_bulanan') }}" step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>

                            <div>
                                <label for="pendapatan_lain" class="block text-xs font-medium text-gray-700 mb-2">Pendapatan Lain (RM)</label>
                                <input type="number" id="pendapatan_lain" name="pendapatan_lain" value="{{ old('pendapatan_lain') }}" step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        <h2 class="text-sm font-semibold text-gray-900 mb-4">6. Maklumat Perumahan</h2>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select id="jenis_kediaman" name="jenis_kediaman" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    ...
                                    @foreach($jenisKediaman as $item)
                                        <option value="{{ $item->nama_kategori }}" {{ old('jenis_kediaman') == $item->nama_kategori ? 'selected' : '' }}>
                                            {{ $item->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                <label for="sewa_bulanan" class="block text-xs font-medium text-gray-700 mb-2">Sewa Bulanan (RM)</label>
                                <input type="number" id="sewa_bulanan" name="sewa_bulanan" value="{{ old('sewa_bulanan') }}" step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                <p class="text-[10px] text-gray-500 mt-1">Isi jika Rumah Sewa</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        <h2 class="text-sm font-semibold text-gray-900 mb-4">7. Kategori Kebajikan</h2>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="flex gap-4">
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="status_oku" value="Ya" {{ old('status_oku') == 'Ya' ? 'checked' : '' }} class="mr-2">
                                        <span class="text-xs">Ya</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="status_oku" value="Tidak" {{ old('status_oku', 'Tidak') == 'Tidak' ? 'checked' : '' }} class="mr-2">
                            ...
                            <div>
                                <label for="jenis_oku" class="block text-xs font-medium text-gray-700 mb-2">Jenis OKU</label>
                                <input type="text" id="jenis_oku" name="jenis_oku" value="{{ old('jenis_oku') }}" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>

                            <div>
                                <label for="no_kad_oku" class="block text-xs font-medium text-gray-700 mb-2">No. Kad OKU</label>
                                <input type="text" id="no_kad_oku" name="no_kad_oku" value="{{ old('no_kad_oku') }}" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            </div>
                            @endif
                            ...
                            <div>
                                ...
                                <div class="flex gap-4">
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="status_yatim" value="Ya" {{ old('status_yatim') == 'Ya' ? 'checked' : '' }} class="mr-2">
                                        <span class="text-xs">Ya</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="status_yatim" value="Tidak" {{ old('status_yatim', 'Tidak') == 'Tidak' ? 'checked' : '' }} class="mr-2">
                                        <span class="text-xs">Tidak</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex gap-4">
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="status_ibu_tunggal" value="Ya" {{ old('status_ibu_tunggal') == 'Ya' ? 'checked' : '' }} class="mr-2">
                                        <span class="text-xs">Ya</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="status_ibu_tunggal" value="Tidak" {{ old('status_ibu_tunggal', 'Tidak') == 'Tidak' ? 'checked' : '' }} class="mr-2">
                                        <span class="text-xs">Tidak</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex gap-4">
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="status_warga_emas" value="Ya" {{ old('status_warga_emas') == 'Ya' ? 'checked' : '' }} class="mr-2">
                                        <span class="text-xs">Ya</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="status_warga_emas" value="Tidak" {{ old('status_warga_emas', 'Tidak') == 'Tidak' ? 'checked' : '' }} class="mr-2">
                                        <span class="text-xs">Tidak</span>
                                    </label>
                                </div>
                            </div>
                        ...
                        @if(($settings['enable_oku'] ?? 'Ya') === 'Tidak' && ($settings['enable_yatim'] ?? 'Ya') === 'Tidak' && ($settings['enable_ibu_tunggal'] ?? 'Ya') === 'Tidak' && ($settings['enable_warga_emas'] ?? 'Ya') === 'Tidak')
                        <div class="bg-yellow-50 border border-yellow-200 rounded p-3">
                            <p class="text-xs text-yellow-800">
                                <span class="material-icons text-sm align-middle mr-1">info</span>
                                Tiada kategori penerima diaktifkan. Sila aktifkan kategori di Tetapan Kebajikan.
                            </p>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        <h2 class="text-sm font-semibold text-gray-900 mb-4">8. Status & Catatan</h2>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <select id="status_penerima" name="status_penerima" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    <option value="Aktif" {{ old('status_penerima', 'Aktif') == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                    <option value="Tidak Aktif" {{ old('status_penerima') == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                    <option value="Tamat" {{ old('status_penerima') == 'Tamat' ? 'selected' : '' }}>Tamat</option>
                                </select>
