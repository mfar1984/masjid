                ...
                <div class="flex items-center" style="gap: 12px !important;">
                    ...
                    <div>
                        <button onclick="toggleAccessDropdown()" class="flex items-center hover:bg-gray-100 rounded transition-colors" style="padding: 4px 8px !important; gap: 4px !important;">
                            <span id="accessLevelText" style="font-family: 'Roboto', sans-serif !important; font-size: 14px !important; color: #3c4043 !important;">Terhad</span>
                            <span class="material-icons" style="font-size: 16px !important; color: #5f6368 !important;">expand_more</span>
                        </button>
                        <div id="accessLevelDescription" style="font-family: 'Roboto', sans-serif !important; font-size: 12px !important; color: #5f6368 !important; margin: 0 0 0 12px !important;">Hanya orang yang ditambah boleh akses</div>
                                </div>
                                    </div>
