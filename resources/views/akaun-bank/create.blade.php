...
<head>
    ...
    <title>Tambah Akaun Bank - E-Masjid</title>
    <x-favicon />
        ...
        <div class="container mx-auto px-0 py-0">
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                ...
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 mb-1">Tambah Akaun Bank</h1>
                        <p class="text-xs text-gray-600">Daftar akaun bank baharu untuk masjid</p>
                    </div>
                ...
                <form method="POST" action="{{ route('akaun-bank.store') }}">
                    @csrf
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select id="nama_bank" name="nama_bank" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    ...
                                    @foreach($namaBank as $bank)
                                        <option value="{{ $bank->nama_kategori }}" {{ old('nama_bank') == $bank->nama_kategori ? 'selected' : '' }}>
                                            {{ $bank->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" id="no_akaun" name="no_akaun" value="{{ old('no_akaun') }}" required maxlength="50" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs" placeholder="Contoh: 1234567890">
                            ...
                            <div>
                                ...
                                <select id="jenis_akaun" name="jenis_akaun" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    ...
                                    @foreach($jenisAkaun as $jenis)
                                        <option value="{{ $jenis->nama_kategori }}" {{ old('jenis_akaun') == $jenis->nama_kategori ? 'selected' : '' }}>
                                            {{ $jenis->nama_kategori }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" id="nama_pemegang_akaun" name="nama_pemegang_akaun" value="{{ old('nama_pemegang_akaun') }}" required maxlength="255" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs" placeholder="Nama seperti di buku akaun">
                            ...
                            <div>
                                ...
                                <input type="text" id="cawangan" name="cawangan" value="{{ old('cawangan') }}" maxlength="255" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs" placeholder="Contoh: Kuching">
                            ...
                            <div>
                                ...
                                <input type="number" id="baki_awal" name="baki_awal" value="{{ old('baki_awal', '0.00') }}" required step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                <p class="text-[10px] text-gray-500 mt-1">Baki semasa akan sama dengan baki awal</p>
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <textarea id="catatan" name="catatan" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs" placeholder="Catatan tambahan tentang akaun ini">{{ old('catatan') }}</textarea>
