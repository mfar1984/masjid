...
<head>
    ...
    <title>Tambah Kategori Aset - E-Masjid</title>
    <x-favicon />
        ...
        <div class="container mx-auto px-0 py-0">
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 mb-1">Tambah Kategori Aset</h1>
                        <p class="text-xs text-gray-600">Daftar kategori aset baharu</p>
                    </div>
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="kod_kategori" name="kod_kategori" value="{{ old('kod_kategori') }}" required maxlength="50" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs uppercase">
                            ...
                            <div>
                                ...
                                <input type="text" id="nama_kategori" name="nama_kategori" value="{{ old('nama_kategori') }}" required maxlength="255" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            ...
                            <div>
                                ...
                                <select id="jenis_kategori" name="jenis_kategori" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    ...
                                    <option value="Tanah & Bangunan" {{ old('jenis_kategori') == 'Tanah & Bangunan' ? 'selected' : '' }}>Tanah & Bangunan</option>
                                    <option value="Kenderaan" {{ old('jenis_kategori') == 'Kenderaan' ? 'selected' : '' }}>Kenderaan</option>
                                    <option value="Peralatan" {{ old('jenis_kategori') == 'Peralatan' ? 'selected' : '' }}>Peralatan</option>
                                    <option value="Perabot" {{ old('jenis_kategori') == 'Perabot' ? 'selected' : '' }}>Perabot</option>
                                    <option value="Elektronik" {{ old('jenis_kategori') == 'Elektronik' ? 'selected' : '' }}>Elektronik</option>
                                    <option value="Lain-lain" {{ old('jenis_kategori') == 'Lain-lain' ? 'selected' : '' }}>Lain-lain</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" id="urutan" name="urutan" value="{{ old('urutan', 0) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="keterangan" name="keterangan" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">{{ old('keterangan') }}</textarea>
                            </div>
