...
<head>
    ...
    <title>Kutipan Lain - E-Masjid</title>
    <x-favicon />
        ...
        <div class="container mx-auto px-0 py-0">
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                ...
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 mb-1">Kutipan Lain-lain</h1>
                        <p class="text-xs text-gray-600">Rekod kutipan lain-lain</p>
                    </div>
                ...
                <form method="POST" action="{{ route('kutipan-dana.store') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="jenis_kutipan" value="Kutipan Lain">

                    <!-- Section 1: Maklumat Kutipan -->
                    <div class="bg-orange-50 rounded-lg p-4 mb-6">
                        <h2 class="text-sm font-semibold text-gray-900 mb-4">Maklumat Kutipan</h2>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="jenis_kutipan_lain" class="block text-xs font-medium text-gray-700 mb-2">Jenis Kutipan *</label>
                                <input type="text" id="jenis_kutipan_lain" name="jenis_kutipan_lain" value="{{ old('jenis_kutipan_lain') }}" required maxlength="100" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs" placeholder="Contoh: Sewa Dewan, Jualan, dll">
                                @error('jenis_kutipan_lain')<span class="text-xs text-red-600">{{ $message }}</span>@enderror
                            </div>
