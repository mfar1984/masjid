...
<head>
    ...
    <title>Edit Permohonan Zakat - E-Masjid</title>
    <x-favicon />
        ...
        <div class="container mx-auto px-0 py-0">
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                ...
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 mb-1">Edit Permohonan Zakat</h1>
                        <p class="text-xs text-gray-600">Kemaskini permohonan bantuan zakat</p>
                    </div>
                ...
                <form method="POST" action="{{ route('permohonan-zakat.update', $permohonanZakat) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select id="asnaf_id" name="asnaf_id" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    ...
                                    @foreach($asnafList as $asnaf)
                                        <option value="{{ $asnaf->id }}" {{ old('asnaf_id', $permohonanZakat->asnaf_id) == $asnaf->id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <input type="date" id="tarikh_permohonan" name="tarikh_permohonan" value="{{ old('tarikh_permohonan', $permohonanZakat->tarikh_permohonan->format('Y-m-d')) }}" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            ...
                            <div>
                                ...
                                <select id="jenis_bantuan" name="jenis_bantuan" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    ...
                                    <option value="Tunai" {{ old('jenis_bantuan', $permohonanZakat->jenis_bantuan) == 'Tunai' ? 'selected' : '' }}>Tunai</option>
                                    <option value="Barangan" {{ old('jenis_bantuan', $permohonanZakat->jenis_bantuan) == 'Barangan' ? 'selected' : '' }}>Barangan</option>
                                    <option value="Pendidikan" {{ old('jenis_bantuan', $permohonanZakat->jenis_bantuan) == 'Pendidikan' ? 'selected' : '' }}>Pendidikan</option>
                                    <option value="Perubatan" {{ old('jenis_bantuan', $permohonanZakat->jenis_bantuan) == 'Perubatan' ? 'selected' : '' }}>Perubatan</option>
                                    <option value="Kecemasan" {{ old('jenis_bantuan', $permohonanZakat->jenis_bantuan) == 'Kecemasan' ? 'selected' : '' }}>Kecemasan</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select id="kategori_bantuan" name="kategori_bantuan" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    ...
                                    <option value="Bulanan" {{ old('kategori_bantuan', $permohonanZakat->kategori_bantuan) == 'Bulanan' ? 'selected' : '' }}>Bulanan</option>
                                    <option value="Sekali" {{ old('kategori_bantuan', $permohonanZakat->kategori_bantuan) == 'Sekali' ? 'selected' : '' }}>Sekali</option>
                                    <option value="Khas" {{ old('kategori_bantuan', $permohonanZakat->kategori_bantuan) == 'Khas' ? 'selected' : '' }}>Khas</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" id="jumlah_dipohon" name="jumlah_dipohon" value="{{ old('jumlah_dipohon', $permohonanZakat->jumlah_dipohon) }}" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                @error('jumlah_dipohon')<span class="text-xs text-red-600">{{ $message }}</span>@enderror
                            </div>

                            <div>
                                <label for="dokumen_sokongan" class="block text-xs font-medium text-gray-700 mb-2">Dokumen Sokongan</label>
                                <input type="file" id="dokumen_sokongan" name="dokumen_sokongan" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="sebab_permohonan" name="sebab_permohonan" rows="4" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">{{ old('sebab_permohonan', $permohonanZakat->sebab_permohonan) }}</textarea>
