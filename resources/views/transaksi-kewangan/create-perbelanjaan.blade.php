...
<head>
    ...
    <title>Tambah Perbelanjaan - E-Masjid</title>
    <x-favicon />
        ...
        <div class="container mx-auto px-0 py-0">
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                ...
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 mb-1">Tambah Perbelanjaan</h1>
                        <p class="text-xs text-gray-600">Rekod perbelanjaan baharu</p>
                    </div>
                ...
                <form method="POST" action="{{ route('transaksi-kewangan.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="kategori_kewangan_id" class="block text-xs font-medium text-gray-700 mb-2">Kategori Perbelanjaan *</label>
                                ...
                                <select id="akaun_bank_id" name="akaun_bank_id" required class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs">
                                    ...
                                    @foreach($akaunBank as $akaun)
                                        <option value="{{ $akaun->id }}" {{ old('akaun_bank_id') == $akaun->id ? 'selected' : '' }}>
                                            {{ $akaun->nama_bank }} - {{ $akaun->no_akaun }} (RM {{ number_format($akaun->baki_semasa, 2) }})
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <!-- Section 2: Butiran Perbelanjaan -->
                    <div class="bg-blue-50 rounded-lg p-4 mb-6">
                        <h2 class="text-sm font-semibold text-gray-900 mb-4">Butiran Perbelanjaan</h2>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="no_rujukan" name="no_rujukan" value="{{ old('no_rujukan') }}" maxlength="100" class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs" placeholder="No. invois, resit, dll">
                                <p class="text-[10px] text-gray-500 mt-1">Contoh: INV-2025-001, RESIT-123</p>
