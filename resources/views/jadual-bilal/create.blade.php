...
<head>
    ...
    <title>Tambah Jadual Bilal - E-Masjid</title>
    <x-favicon />
        ...
        <div class="container mx-auto px-0 py-0">
            <div class="bg-white shadow-lg border-x border-gray-200 p-6">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900 mb-1">Tambah Jadual Bilal</h1>
                        <p class="text-xs text-gray-600">Daftar jadual tugas bilal baru</p>
                    </div>
                </div>
                <form action="{{ route('jadual-bilal.store') }}" method="POST">
                    @csrf
                    <div class="bg-gray-50 p-4 rounded-md border border-gray-200 max-w-2xl">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_bilal" id="nama_bilal" value="{{ old('nama_bilal') }}" required class="w-full px-3 py-2 text-xs border border-gray-300 rounded-md">
                                @error('nama_bilal')<span class="text-red-500 text-xs">{{ $message }}</span>@enderror
                            </div>
                            <div>
